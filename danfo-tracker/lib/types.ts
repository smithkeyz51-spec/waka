...
// All 20 constitutionally recognized LGAs in Lagos State (IBILE divisions).
...
// Popular stops/landmarks within each Lagos LGA, used for autocomplete.
// Not exhaustive — a mix of motor parks, markets, and well-known bus stops.
...
// Flat list combining all Lagos stops, for the general datalist/autocomplete.
export const LAGOS_ALL_STOPS = Object.values(LAGOS_LGA_STOPS).flat();

// Seed list of common stops for other cities, used for autocomplete suggestions.
// Not exhaustive — just enough to make the form feel alive on first run.
